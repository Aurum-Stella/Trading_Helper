...
#  Apr 12, 2022 05:02:21 PM EEST  platform: Windows NT
set vTcl(timestamp) ""
...
proc vTclWindow.top1 {base} {
    ...
    wm geometry $top 600x450+340+90
    update
    # set in toplevel.wgt.
    global vTcl
    global img_list
    ...
    ###################
    place $top.tSe46 \
        -in $top -x 0 -relx 0.267 -y 0 -rely 0.333 -width 0 -relwidth 0.517 \
        -height 0 -relheight 0.004 -anchor nw -bordermode ignore 
    place $top.ent48 \
        -in $top -x 0 -relx 0.083 -y 0 -rely 0.333 -width 84 -relwidth 0 \
